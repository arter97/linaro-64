...
enum opt_code
{
  ...
  OPT_mstrict_align = 1196,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1197,                  /* -mtls-dialect= */
  OPT_mtls_size_ = 1198,                     /* -mtls-size= */
  OPT_mtune_ = 1199,                         /* -mtune= */
  OPT_n = 1200,                              /* -n */
  ...
  OPT_pie = 1216,                            /* -pie */
  OPT_pipe = 1217,                           /* -pipe */
  OPT_print_file_name_ = 1218,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1219,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1220,          /* -print-multi-directory */
  OPT_print_multi_lib = 1221,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1222,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1223,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1224,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1225,               /* -print-prog-name= */
  OPT_print_search_dirs = 1226,              /* -print-search-dirs */
  OPT_print_sysroot = 1227,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1228,   /* -print-sysroot-headers-suffix */
