/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain64-5.2.0/build/objdir/../build/../gcc/gcc-5.2.0/gcc/config/aarch64/aarch64.md'.  */
