/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/tmp/dgboter/bbs/bc-b1-2-12--rhe6x86_64/buildbot/rhe6x86_64--aarch64-linux-gnu/build/src/gcc/gcc/config/aarch64/aarch64.md'.  */
